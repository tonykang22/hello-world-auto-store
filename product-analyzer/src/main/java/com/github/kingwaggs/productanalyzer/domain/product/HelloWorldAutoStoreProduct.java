...
import com.github.kingwaggs.productanalyzer.domain.Currency;
import com.github.kingwaggs.productanalyzer.domain.SaleStatus;
import com.github.kingwaggs.productanalyzer.domain.Vendor;
import com.github.kingwaggs.productanalyzer.domain.dto.HelloWorldAutoStoreProductDto;
import com.github.kingwaggs.productanalyzer.util.DateTimeConverter;
import lombok.*;
...
public class HelloWorldAutoStoreProduct {
    ...
    public static HelloWorldAutoStoreProduct createFrom(HelloWorldAutoStoreProductDto dto, String sourceId, String destinationId, SaleStatus saleStatus) {
        return HelloWorldAutoStoreProduct.builder()
                ...
                .sourceCurrency(Currency.valueOf(dto.getSourceCurrency()))
                .destinationOriginalPrice(dto.getDestinationOriginalPrice())
                .destinationDiscountPrice(dto.getDestinationSalePrice())
                .destinationCurrency(Currency.valueOf(dto.getDestinationCurrency()))
