...
public class DateTimeConverter {
    ...
    public static final String COUPANG_DATE_TIME_FORMAT = "yyyy-MM-dd HH:mm:ss";
    ...
    public static LocalDateTime coupangDateTimeString2LocalDateTime(String dateTimeString) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern(COUPANG_DATE_TIME_FORMAT);
        return LocalDateTime.parse(dateTimeString, formatter);
    }
